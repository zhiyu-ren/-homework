...
修复说明：
  1. ✅ /welcome — SSTI修复：使用render_template传参代替f-string拼接
  2. ✅ /feedback — SSTI修复：使用render_template传参代替f-string拼接
"""
...
@app.route("/health")
def health():
    return jsonify({"status": "ok", "version": "8.0.0-ssti"}), 200
...
if __name__ == "__main__":
    logger.info("用户管理系统(SSTI演示版)启动: 0.0.0.0:5000")
