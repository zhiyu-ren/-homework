#!/usr/bin/env python3
"""
用户信息管理系统 - 动态页面加载版（含路径遍历漏洞）
====================================================
基于 Class05，新增动态页面加载功能

漏洞说明：
  1. 🔴 /page?name=X — 路径遍历：未对 name 参数做 ../ 过滤，可读取任意文件
"""
...
@app.route("/health")
def health():
    return jsonify({"status": "ok", "version": "6.0.0-vuln"}), 200
...
if __name__ == "__main__":
    logger.info("用户管理系统(动态页面加载版)启动: 0.0.0.0:5000")
