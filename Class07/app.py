...
用户信息管理系统 - CSRF漏洞修复版
===================================
基于 Class06，修复修改密码功能中的CSRF/越权/无密码验证漏洞

修复说明：
  1. ✅ /change-password — CSRF Token 验证
  2. ✅ /change-password — 水平越权修复：从session获取用户
  3. ✅ /change-password — 原密码验证
"""
...
@app.route("/health")
def health():
    return jsonify({"status": "ok", "version": "7.0.0-secure"}), 200
...
if __name__ == "__main__":
    logger.info("用户管理系统(CSRF修复版)启动: 0.0.0.0:5000")
